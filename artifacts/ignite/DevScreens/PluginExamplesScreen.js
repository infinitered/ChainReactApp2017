...
class PluginExamplesScreen extends React.Component {
    render() {
        return (React.createElement(View, { style: styles.mainContainer },
            ...
            React.createElement(TouchableOpacity, { onPress: () => this.props.navigation.goBack(null), style: {
                    position: 'absolute',
                    paddingTop: 30,
                    paddingHorizontal: 5,
                    zIndex: 10
            ...
            React.createElement(ScrollView, { style: styles.container },
                React.createElement(View, { style: { alignItems: 'center', paddingTop: 60 } },
                    React.createElement(Image, { source: Images.usageExamples, style: styles.logo }),
                    React.createElement(Text, { style: styles.titleText }, "Plugin Examples")),
                React.createElement(View, { style: styles.section },
                    React.createElement(Text, { style: styles.sectionText }, "The Plugin Examples screen is a playground for 3rd party libs and logic proofs. Items on this screen can be composed of multiple components working in concert.  Functionality demos of libs and practices")),
                ExamplesRegistry.renderPluginExamples(),
                React.createElement(View, { style: styles.screenButtons }))));
    }
}
