    ...
    *************************************************************/
    ...
    render() {
        return (React.createElement(View, { style: styles.container },
            React.createElement(ListView, { renderSectionHeader: this._renderHeader, contentContainerStyle: styles.listContent, dataSource: this.state.dataSource, onLayout: this.onLayout, renderRow: this._renderRow, enableEmptySections: true })));
    }
}
