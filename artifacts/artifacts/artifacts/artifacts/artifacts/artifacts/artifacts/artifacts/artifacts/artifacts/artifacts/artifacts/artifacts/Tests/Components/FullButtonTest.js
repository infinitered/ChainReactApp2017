...
// Basic wrapper
const wrapper = shallow(React.createElement(FullButton, { onPress: () => { }, text: 'hi' }));
...
test('onPress', (t) => {
    ...
    const onPress = () => i++;
    const wrapperPress = shallow(React.createElement(FullButton, { onPress: onPress, text: 'hi' }));
    t.is(wrapperPress.prop('onPress'), onPress); // uses the right handler
    t.is(i, 0);
    wrapperPress.simulate('press');
    t.is(i, 1);
});
//# sourceMappingURL=FullButtonTest.js.map 
//# sourceMappingURL=FullButtonTest.js.map 
//# sourceMappingURL=FullButtonTest.js.map 
//# sourceMappingURL=FullButtonTest.js.map 
//# sourceMappingURL=FullButtonTest.js.map 
