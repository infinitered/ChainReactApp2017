...
class ListviewSectionsExample extends React.Component {
    ...
    *************************************************************/
    _renderRow(rowData, sectionID) {
        ...
        return (React.createElement(View, { style: styles.row }, React.createElement(Text, { style: styles.boldLabel }, "Section ", sectionID, " - ", rowData.title), React.createElement(Text, { style: styles.label }, rowData.description)));
    }
    /* ***********************************************************
    * STEP 4
    ...
    *************************************************************/
    ...
    render() {
        return (React.createElement(View, { style: styles.container }, React.createElement(ListView, { renderSectionHeader: this._renderHeader, contentContainerStyle: styles.listContent, dataSource: this.state.dataSource, onLayout: this.onLayout, renderRow: this._renderRow, enableEmptySections: true })));
    }
}
...
//# sourceMappingURL=SectionExample.js.map 
//# sourceMappingURL=SectionExample.js.map 
//# sourceMappingURL=SectionExample.js.map 
//# sourceMappingURL=SectionExample.js.map