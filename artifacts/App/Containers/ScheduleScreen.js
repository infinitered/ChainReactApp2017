...
class ScheduleScreen extends React.Component {
    ...
    renderDayToggle() {
        ...
        return (React.createElement(LinearGradient, { start: { x: 0, y: 0 }, end: { x: 1, y: 1 }, locations: [0.0, 0.38, 1.0], colors: ['#46114E', '#521655', '#571757'], style: styles.headerGradient },
            React.createElement(View, { style: styles.dayToggle },
                React.createElement(TouchableOpacity, { onPressIn: () => this.setActiveDay(0) },
                    React.createElement(Text, { style: activeDay === 0 ? styles.activeDay : styles.inactiveDay }, "Monday")),
                React.createElement(TouchableOpacity, { onPressIn: () => this.setActiveDay(1) },
                    React.createElement(Text, { style: activeDay === 1 ? styles.activeDay : styles.inactiveDay }, "Tuesday")))));
    }
    render() {
        return (React.createElement(PurpleGradient, { style: styles.linearGradient },
            this.renderDayToggle(),
            this.state.isCurrentDay && React.createElement(View, { style: styles.timeline }),
            React.createElement(ListView, { ref: 'listView', contentContainerStyle: styles.listContent, dataSource: this.state.dataSource, onLayout: this.onLayout, renderRow: this.renderRow, enableEmptySections: true })));
    }
}
