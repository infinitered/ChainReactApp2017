        ...
        return (React.createElement(ScrollView, { contentContainerStyle: { justifyContent: 'center' }, style: [Styles.container, { height: this.state.visibleHeight }], keyboardShouldPersistTaps: 'always' },
            ...
            React.createElement(View, { style: Styles.form },
                ...
                React.createElement(View, { style: [Styles.loginRow] },
                    ...
                    React.createElement(TouchableOpacity, { style: Styles.loginButtonWrapper, onPress: () => this.props.navigation.goBack() },
                        React.createElement(View, { style: Styles.loginButton },
                            React.createElement(Text, { style: Styles.loginText }, "Cancel")))))));
    }
}
