...
const TimeIndicator = props => {
    ...
    return (React.createElement(View, { style: [styles.container, { top }] },
        React.createElement(Text, { style: styles.time }, formattedTime),
        React.createElement(Image, { style: styles.icon, source: sunIcon(time) })));
};
