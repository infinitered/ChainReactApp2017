            ...
            React.createElement(TouchableOpacity, { onPress: this.props.onPress },
                React.createElement(View, { style: containerStyles },
                    React.createElement(View, { style: styles.info },
                        React.createElement(View, { style: styles.infoText },
                            React.createElement(Text, { style: styles.name }, name),
                            React.createElement(Text, { style: styles.title }, title)),
                        React.createElement(Image, { style: styles.avatar, source: { uri: avatarURL } })),
                    React.createElement(TalkInfo, { start: start, duration: duration, remindMe: this.props.isSpecial, isFinished: isFinished || isActive, showWhenFinished: this.props.showWhenFinished, toggleRemindMe: this.toggleReminder, onPressGithub: this.props.onPressGithub, onPressTwitter: this.props.onPressTwitter }))),
            isActive &&
