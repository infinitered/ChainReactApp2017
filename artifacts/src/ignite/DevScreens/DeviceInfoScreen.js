    ...
    renderCard(cardTitle, rowData) {
        return (React.createElement(View, null,
            React.createElement(View, { style: styles.sectionHeaderContainer },
                React.createElement(Text, { style: styles.sectionHeader }, cardTitle.toUpperCase())),
            this.renderRows(rowData)));
    }
    renderRows(rowData) {
        return rowData.map((cell) => {
            const { title, info } = cell;
            return (React.createElement(View, { key: title, style: styles.rowContainer },
                React.createElement(View, { style: styles.rowLabelContainer },
                    React.createElement(Text, { style: styles.rowLabel }, title)),
                React.createElement(View, { style: styles.rowInfoContainer },
                    React.createElement(Text, { style: styles.rowInfo }, info))));
        });
    }
    render() {
        return (React.createElement(View, { style: styles.mainContainer },
            ...
            React.createElement(ScrollView, { style: styles.container },
                React.createElement(View, { style: { alignItems: 'center', paddingTop: 60 } },
                    React.createElement(Image, { source: Images.deviceInfo, style: styles.logo }),
                    React.createElement(Text, { style: styles.titleText }, "Device Info")),
                React.createElement(View, { style: styles.section },
                    React.createElement(Text, { style: styles.sectionText }, "Dedicated to identifying specifics of the device.  All info useful for identifying outlying behaviour specific to a device.")),
