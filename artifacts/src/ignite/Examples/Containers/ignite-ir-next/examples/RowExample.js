    ...
    *************************************************************/
    _renderRow(rowData) {
        return (React.createElement(View, { style: styles.row },
            React.createElement(Text, { style: styles.boldLabel }, rowData.title),
    ...
    *************************************************************/
    ...
    render() {
        return (React.createElement(View, { style: styles.container },
            React.createElement(ListView, { contentContainerStyle: styles.listContent, dataSource: this.state.dataSource, renderRow: this._renderRow, renderFooter: this._renderFooter, enableEmptySections: true, pageSize: 15 })));
    }
}
...
//# sourceMappingURL=RowExample.js.map