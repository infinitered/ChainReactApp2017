    ...
    constructor(props) {
        ...
        this.renderMainImage = () => {
            ...
            return (React.createElement(View, { style: styles.mainImageContainer },
                React.createElement(Image, { style: [styles.mainImage, { width: this.state.imageWidth }], source: mainImage }),
                React.createElement(View, { style: styles.mainHeadingContainer },
                    React.createElement(Text, { style: styles.breakHeading },
                        this.props.type.toUpperCase(),
                        " BREAK"),
                    React.createElement(Text, { style: styles.breakDuration },
                        React.createElement(Text, null,
                            prettyStartTime,
                            " - ",
                            prettyEndTime),
                        React.createElement(Text, { style: styles.meridiem }, meridiem)))));
        };
        ...
        return (React.createElement(PurpleGradient, { style: styles.linearGradient },
            React.createElement(ScrollView, null,
                React.createElement(View, { style: styles.container },
                    ...
                    React.createElement(View, { style: styles.card, onLayout: this.onCardLayout },
                        this.renderMainImage(),
                        React.createElement(View, { style: styles.content },
                            React.createElement(Text, { style: styles.heading },
                                this.props.type === 'lunch' ? 'Lunch' : 'Refreshment',
                                " Options"),
                            React.createElement(View, { style: styles.descriptionContainer }, this.renderOptions(options)),
                            React.createElement(Text, { style: styles.heading }, "Vegan Options"),
                            React.createElement(View, { style: styles.descriptionContainer }, this.renderOptions(veganOptions))))))));
    }
}
