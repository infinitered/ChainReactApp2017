...
class LocationScreen extends React.Component {
        ...
        this.renderHeader = () => {
            ...
            return (React.createElement(Animated.View, { style: {
                ...
                React.createElement(View, { style: styles.headingContainer },
                    React.createElement(Text, { style: styles.mainHeading }, "The Armory"),
                    React.createElement(Text, { style: styles.address },
                        "128 NW Eleventh Ave",
                        '\n',
                        "Portland, OR 97209"))));
        };
    ...
    render() {
        ...
        return (React.createElement(PurpleGradient, { style: [styles.linearGradient, { flex: 1 }] },
            React.createElement(ScrollView, { ref: 'scrolly', onScroll: event([{ nativeEvent: { contentOffset: { y: this.state.scrollY } } }]), scrollEventThrottle: 10, scrollEnabled: !this.state.mapViewMode },
                React.createElement(View, { style: styles.container },
                    this.renderBackground(),
                    this.renderHeader(),
                    React.createElement(View, Object.assign({ ref: 'mapContainer' }, this._panResponder.panHandlers),
                        React.createElement(VenueMap, { mapViewMode: mapViewMode, onCloseMap: this.onCloseMap, scrollEnabled: mapViewMode, style: [styles.map, mapViewMode && { height: Metrics.screenHeight / 2 }] })),
                    React.createElement(View, { style: styles.mapActions },
                        React.createElement(TouchableOpacity, { onPress: () => this.openMaps() },
                            React.createElement(View, { style: styles.getDirections },
                                React.createElement(View, { style: styles.addressContainer },
                                    React.createElement(Text, { style: styles.venueName }, "The Armory"),
                                    React.createElement(Text, { style: styles.venueAddress },
                                        "128 NW Eleventh Ave.",
                                        '\n',
                                        "Portland, OR 97209")),
                                React.createElement(View, { style: styles.directionsIcon },
                                    React.createElement(Image, { source: Images.directionsIcon }),
                                    React.createElement(Text, { style: styles.directionsLabel }, "Directions")))),
                        React.createElement(TouchableOpacity, { onPress: () => this.toggleRides() },
                            React.createElement(View, { style: styles.getRide },
                                React.createElement(Text, { style: styles.getRideLabel }, "Taking an Uber or Lyft?"),
                                React.createElement(Image, { style: [styles.getRideIcon, showRideOptions && styles.flip], source: Images.chevronIcon })))),
                    React.createElement(View, { style: [styles.rideOptions, showRideOptions && { height: 170 }] },
                        React.createElement(TouchableOpacity, { onPress: () => this.openLyft() },
                            React.createElement(Image, { style: styles.rideButton, source: Images.lyftButton })),
                        React.createElement(TouchableOpacity, { onPress: () => this.openUber() },
                            React.createElement(Image, { style: styles.rideButton, source: Images.uberButton }))),
                    React.createElement(View, { style: styles.nearby },
                        React.createElement(Text, { style: styles.mainHeading }, "Nearby")),
                    React.createElement(Gallery, { data: nearbyData, onItemPress: (daddr) => this.openMaps(daddr) })))));
    }
}
