...
const RoundedButton = props => {
    ...
    return (React.createElement(TouchableOpacity, { style: [styles.button, props.style], onPress: props.onPress },
        React.createElement(Text, { style: styles.buttonText }, getText())));
};
