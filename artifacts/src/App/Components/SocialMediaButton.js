...
const SocialMediaButton = props => {
    ...
    return (React.createElement(TouchableOpacity, { style: [styles.button, styles[spacingShim], style], onPress: onPress, hitSlop: { top: 10, left: 10, bottom: 10, right: 10 } },
        React.createElement(Image, { source: imageSource })));
};
