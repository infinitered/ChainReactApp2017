...
const FullButton = (props) => {
    return (React.createElement(TouchableOpacity, { style: [styles.button, props.styles], onPress: props.onPress },
        React.createElement(Text, { style: styles.buttonText }, props.text.toUpperCase())));
};
