    ...
    return (React.createElement(View, { style: styles.container },
        React.createElement(View, { style: styles.details },
            React.createElement(View, { style: styles.detail },
                React.createElement(Text, { style: styles.detailLabel }, "Start"),
                React.createElement(Text, { style: styles.detailText }, formattedStart)),
            React.createElement(View, { style: styles.detail },
                React.createElement(Text, { style: styles.detailLabel }, "Duration"),
                React.createElement(Text, { style: styles.detailText }, `${duration} Minutes`))),
        showRemindMe &&
            React.createElement(View, { style: styles.remindMe },
                React.createElement(RemindMeButton, { onPress: toggleRemindMe, on: remindMe })),
        showSocialMedia &&
            React.createElement(View, { style: styles.socialButtons },
                React.createElement(SocialMediaButton, { network: 'twitter', onPress: props.onPressTwitter }),
                React.createElement(SocialMediaButton, { network: 'github', onPress: props.onPressGithub }))));
};
TalkInfo.propTypes = {
